...
<div id="kprofile-edit">
	...
	<div class="kbutton-container">
		<button class="btn btn-primary ks validate" type="submit"><?php echo JText::_('COM_KUNENA_SAVE'); ?></button>
		<button type="button" name="cancel" class="btn btn-primary" value="<?php echo (' ' . JText::_('COM_KUNENA_CANCEL') . ' ');?>"
			onclick="window.history.back();"
			title="<?php echo (JText::_('COM_KUNENA_EDITOR_HELPLINE_CANCEL'));?>"><?php echo (' ' . JText::_('COM_KUNENA_CANCEL') . ' ');?></button>
	</div>
</div>
</form>
