...
//get sticked comment
$sticked = Komento::getModel('comments')->getCount($component, $cid, array('sticked' => 1, 'threaded' => 0));

//get lovies comment
$lovies = Komento::getModel('comments')->getTotalPopularComments($component, $cid, array('threaded' => 0));
...
<div id="kmt-fame" class="fameList">
	...
	<?php if($system->config->get('enable_stickies') && $system->my->allow('read_stickies') && $commentCount > 0 && $sticked > 0) { ?>
	...
	<?php }
	if($system->config->get('enable_lovies') && $system->my->allow('read_lovies') && $commentCount > 0 && $lovies > 0) { ?>
		<li>
