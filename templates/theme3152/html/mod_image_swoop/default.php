...
<div id="camera-slideshow_counter_<?php echo $module->id; ?>" class="camera_counter">
<span class="camera_counter_current">1</span>/<span class="camera_counter_all"><?php echo count($list);?></span>
</div>
<script>
	jQuery(function(){
		var slider = jQuery('#camera-slideshow_<?php echo $module->id; ?>')
		slider.camera({
			...
			onEndTransition	: function() {
				jQuery('#camera-slideshow_counter_<?php echo $module->id; ?> span.camera_counter_current').text(slider.find('.camera_target .cameraSlide.cameracurrent').index()+1);
