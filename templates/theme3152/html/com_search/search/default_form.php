...
<form id="searchForm" action="<?php echo JRoute::_('index.php?option=com_search');?>" method="post">
    ...
    <<?php echo $template->params->get('categoryItemHeading','h4'); ?>><?php echo $this->escape(JText::_('COM_SEARCH_FOR')); ?></<?php echo $template->params->get('categoryItemHeading','h4'); ?>>
	...
	<fieldset class="only">
    <<?php echo $template->params->get('categoryItemHeading','h4'); ?>><?php echo $this->escape(JText::_('COM_SEARCH_SEARCH_ONLY')); ?></<?php echo $template->params->get('categoryItemHeading','h4'); ?>>
